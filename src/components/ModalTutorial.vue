...
<template>
  <BaseModal>
    ...
    >
      ...
      <h1
        class="mt-2 bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text font-bebas text-4xl text-transparent md:text-5xl lg:mt-3"
      >
        Welcome!
      </h1>
      <div class="text-textLight dark:text-textDark lg:text-lg">
        <p class="mt-3">
          ...
          clicking the <span class="font-bold text-red-500">X</span> button on
          the top-right corner.
        </p>
        <p class="mt-5">
          If you're new to this site, I recommend that you check out the
          tutorial section to learn how to use the features of this site.
        </p>
      </div>
      <button
        type="button"
