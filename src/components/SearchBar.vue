...
<template>
  <div class="mt-10 flex justify-center">
    <input
      ...
      class="input-search w-2/3 rounded-l-full border-2 border-r-0 border-black/80 bg-white/60 px-5 py-2 text-xl text-textLight outline-none placeholder:font-inter placeholder:text-textLight focus:bg-white/90 dark:border-white/50 dark:bg-black/50 dark:text-textDark dark:placeholder:text-textDark dark:focus:bg-black/70 md:text-2xl"
    />
    <button
    ...
    >
      <svg
        ...
        class="h-6 w-6 stroke-primary md:h-7 md:w-7"
      >
